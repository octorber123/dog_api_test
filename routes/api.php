...
Route::prefix('users')->group(function () {
    ...
    // THAT ACCEPTS A TYPE AND ID IN THE REQUEST AND HANDLES MULTIPLE ASSOCIATION TYPES. GOOD IDEA FOR SMALL APPLICATION OR TESTS ;)
    // THE BELOW HOWEVER IS USEFUL WHEN RELATIONSHIPS GROW OR ARE DYNAMIC OR REQUIRE OTHER LOGIC. 
    // FOR THIS EXERCISE, I’VE USED SEPARATE CONTROLLERS TO FOLLOW RESTFUL BEST PRACTICES. :D
